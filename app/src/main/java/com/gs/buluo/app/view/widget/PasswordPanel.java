...
public class PasswordPanel extends Dialog implements Callback<PaymentResponse> {
    ...
    public PasswordPanel(Context context, String pwd, List<String> orderId, OrderBean.PayChannel channel) {
...
//        View rootView = LayoutInflater.from(mContext).inflate(, null);
    ...
    public void onResponse(Call<PaymentResponse> call, Response<PaymentResponse> response) {
        if (response.body()!=null&&response.code()==ResponseCode.UPDATE_SUCCESS){
