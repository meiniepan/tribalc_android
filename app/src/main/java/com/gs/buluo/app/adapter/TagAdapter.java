...
public class TagAdapter extends BaseQuickAdapter<ConferenceEquipment, BaseHolder> {
    public TagAdapter(int layoutResId, @Nullable List<ConferenceEquipment> data) {
        super(layoutResId, data);
    }


    @Override
    protected void convert(BaseHolder helper, ConferenceEquipment item) {
        helper.setText(R.id.tag_content, item.name);
