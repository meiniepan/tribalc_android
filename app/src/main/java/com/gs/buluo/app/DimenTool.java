        ...
        try {
            ...
            while ((tempString = reader.readLine()) != null) {
                if (tempString.contains("</dimen>")) {
                    ...
                    w1080.append(start).append((int) Math.round(num * 1.4)).append(end).append("\n");
                } else {
            ...
            String sw1080file = "../res/values-1080x1920/dimens.xml";
//            writeFile(sw480file, sw480.toString());
//            writeFile(sw600file, sw600.toString());
//            writeFile(sw720file, sw720.toString());
            writeFile(sw1080file, w1080.toString());
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
            if (reader != null) {
