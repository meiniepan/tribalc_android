...
public class RippleView extends View implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
    ...
    private void init() {
        ...
        //初始化实心内圆画笔
        mInPaint.setColor(getResources().getColor(R.color.white));
        mInPaint.setAntiAlias(true);
        mInPaint.setStyle(Paint.Style.FILL);

        //初始化空心内圆画笔
        mInStrokePaint.setColor(getResources().getColor(R.color.white));
        ...
        //初始化空心外圆画笔
        mOutStrokePaint.setColor(getResources().getColor(R.color.white));
