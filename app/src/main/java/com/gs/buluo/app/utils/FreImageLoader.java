 ...
 */
public class FreImageLoader implements cn.finalteam.galleryfinal.ImageLoader {

    private Context context;

    public FreImageLoader(Context context) {
        this(context, Bitmap.Config.RGB_565);
    }

    public FreImageLoader(Context context, Bitmap.Config config) {
