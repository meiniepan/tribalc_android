...
// */
//public class PickerPop extends PopupWindow implements View.OnClickListener {
//    /**
...
//        }
//
//        public PickerPop build() {
//            if (minYear > maxYear) {
//                throw new IllegalArgumentException();
//            }
//            return new PickerPop(this);
//        }
//
...
//    }
//
//    public PickerPop(Builder builder) {
...
//
//        contentView = LayoutInflater.from(mContext).inflate(showDayMonthYear ? com.bruce.pickerview.R.layout.layout_date_picker_inverted : com.bruce.pickerview.R.layout.layout_date_picker, null);
//        cancelBtn = (Button) contentView.findViewById(com.bruce.pickerview.R.id.btn_cancel);
//        confirmBtn = (Button) contentView.findViewById(com.bruce.pickerview.R.id.btn_confirm);
//        yearLoopView = (LoopView) contentView.findViewById(com.bruce.pickerview.R.id.picker_year);
//        monthLoopView = (LoopView) contentView.findViewById(com.bruce.pickerview.R.id.picker_month);
//        dayLoopView = (LoopView) contentView.findViewById(com.bruce.pickerview.R.id.picker_day);
//        pickerContainerV = contentView.findViewById(com.bruce.pickerview.R.id.container_picker);
//
