...
import com.gs.buluo.app.view.holder.BaseHolder;
 ...
 */
public class BaseRecycleAdapter<T> extends RecyclerView.Adapter<BaseHolder<T>> {
    ...
    public BaseRecycleAdapter(List<T> mDatas, int mResLayout, Class<? extends BaseHolder<T>> mClazz) {
        if (mClazz == null) {
    ...
    public BaseRecycleAdapter setTag(int tag, Object mObject) {
        if (mObject != null) {
